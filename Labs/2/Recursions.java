...
public class Recursions{
        ...
        */
        ...
        /* ConvertToBinary(head)
           Given a linked list of integers (starting at the node provided), 
           create a list consisting of the binary representation of the value
           of each node.
           
           For example, the list [4, 5, 6] would be converted to the list 
           [1, 0, 0, 1, 0, 1, 1, 1, 0].
        */
        public ListNode ConvertToBinary(ListNode head){
            /* Your code here */
            return null;
        }
        ...
        */
        public ListNode ExtractEven(ListNode head){
          ...
          if (head.value % 2 == 1) {
            ...
            ListNode newNode = new ListNode(head.value, ExtractEven(head.next));
            return newNode;
          }
        }
        ...
        */
        public ListNode ValuePlusIndex(int index, ListNode head){
          ...
          ListNode newNode = new ListNode(head.value + index, ValuePlusIndex(index + 1, head.next));
          return newNode;
        }
        ...
        */
        public static void main(String[] args){
                ...
                ListNode BinaryListHead = m.ConvertToBinary(inputListHead);
                System.out.println("In binary");
                m.printList(BinaryListHead);
