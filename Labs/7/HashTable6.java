/* HashTable6.java
   CSC 225 - Fall 2015
   Template for string hashing (version 6)
   
   === Version 6 ===
   Modify the code below to achieve better performance on the file 
   place_names_large.txt than any of versions 1-5.
   =================
